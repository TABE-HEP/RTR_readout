...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   if(!before_laser_val_file->IsOpen() || !after_laser_val_file->IsOpen() || !before_dark_val_file->IsOpen() || !after_dark_val_file->IsOpen()){
      ...
      c0->BuildLegend();
      c0->Write();
      std::string filename0 = config.output_filename+"_cut_value.png";
      c0->SaveAs(filename0.c_str());
      filename0 = config.output_filename+"_cut_value.root";
      c0->SaveAs(filename0.c_str());
      ...
      // dark_rate, before_dark_rate, after_dark_rate
      ...
      // c1->Write();
      c1->BuildLegend();
      std::string filename = config.output_filename+"_dark_rate.png";
      c1->SaveAs(filename.c_str());
      filename = config.output_filename+"_dark_rate.root";
      c1->SaveAs(filename.c_str());
      TCanvas* c2 = new TCanvas("c2","c2",800,800);
      before_dark_rate_hist->Draw("colz");
      filename = config.output_filename+"_before_dark_rate_hist.png";
      c2->SaveAs(filename.c_str());
      filename = config.output_filename+"_before_dark_rate_hist.root";
      c2->SaveAs(filename.c_str());
      TCanvas* c3 = new TCanvas("c3","c3",800,800);
      after_dark_rate_hist->Draw("colz");
      filename = config.output_filename+"_after_dark_rate_hist.png";
      c3->SaveAs(filename.c_str());
      filename = config.output_filename+"_after_dark_rate_hist.root";
      c3->SaveAs(filename.c_str());
   ...
   std::string filename1 = config.output_filename+"_before_sum_ch.png";
   c31->SaveAs(filename1.c_str());
   filename1 = config.output_filename+"_before_sum_ch.root";
   c31->SaveAs(filename1.c_str());
   TCanvas* c4 = new TCanvas("c4","c4",800,800);
   before_sum_ch_withcut_hist->Draw("colz");
   filename1 = config.output_filename+"_before_sum_ch_withcut.png";
   c4->SaveAs(filename1.c_str());
   filename1 = config.output_filename+"_before_sum_ch_withcut.root";
   c4->SaveAs(filename1.c_str());
   TCanvas* c5 = new TCanvas("c5","c5",800,800);
   after_sum_ch_hist->Draw("colz");
   filename1 = config.output_filename+"_after_sum_ch.png";
   c5->SaveAs(filename1.c_str());
   filename1 = config.output_filename+"_after_sum_ch.root";
   c5->SaveAs(filename1.c_str());
   TCanvas* c6 = new TCanvas("c6","c6",800,800);
   after_sum_ch_withcut_hist->Draw("colz");
   filename1 = config.output_filename+"_after_sum_ch_withcut.png";
   c6->SaveAs(filename1.c_str());
   filename1 = config.output_filename+"_after_sum_ch_withcut.root";
   c6->SaveAs(filename1.c_str());
   TCanvas*c7 = new TCanvas("c7","c7",800,800);
   before_sumhist->Draw();
   filename1 = config.output_filename+"_before_sum.png";
   c7->SaveAs(filename1.c_str());
   filename1 = config.output_filename+"_before_sum.root";
   c7->SaveAs(filename1.c_str());
   TCanvas*c8 = new TCanvas("c8","c8",800,800);
   after_sumhist->Draw();
   filename1 = config.output_filename+"_after_sum.png";
   c8->SaveAs(filename1.c_str());
   filename1 = config.output_filename+"_after_sum.root";
   c8->SaveAs(filename1.c_str());
   filename1 = config.output_filename+"_sumhist.root";
   ...
   std::string filename10 = config.output_filename+"_rate_before_hist.png";
   c10->SaveAs(filename10.c_str());
   filename10 = config.output_filename+"_rate_before_hist.root";
   c10->SaveAs(filename10.c_str());
   TCanvas* c11 = new TCanvas("c11","c11",800,800);
   rate_after_hist->Draw("colz");
   std::string filename11 = config.output_filename+"_rate_after_hist.png";
   c11->SaveAs(filename11.c_str());
   filename11 = config.output_filename+"_rate_after_hist.root";
   c11->SaveAs(filename11.c_str());
   TCanvas* c12 = new TCanvas("c12","c12",800,800);
   rate_before_withcut_hist->Draw("colz");
   std::string filename12 = config.output_filename+"_rate_before_withcut_hist.png";
   c12->SaveAs(filename12.c_str());
   filename12 = config.output_filename+"_rate_before_withcut_hist.root";
   c12->SaveAs(filename12.c_str());
   TCanvas* c13 = new TCanvas("c13","c13",800,800);
   rate_after_withcut_hist->Draw("colz");
   std::string filename13 = config.output_filename+"_rate_after_withcut_hist.png";
   c13->SaveAs(filename13.c_str());
   filename13 = config.output_filename+"_rate_after_withcut_hist.root";
   c13->SaveAs(filename13.c_str());
   ...
   c20->BuildLegend();
   std::string filename20 = config.output_filename+"_rate_withcut.png";
   c20->SaveAs(filename20.c_str());
   filename20 = config.output_filename+"_rate_withcut.root";
   c20->SaveAs(filename20.c_str());
   ...
   c21->BuildLegend();
   std::string filename2 = config.output_filename+"_rate.png";
   ...
   std::string filename3 = config.output_filename+"_rate.root";
...
int main(int argc, char* argv[]){
   ...
   std::string filename = config.output_filename+".root";
